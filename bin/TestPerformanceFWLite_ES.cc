...
int main(int argc, char ** argv)
{
  ...
  TFile f("TrackCountingHigheffBlah.root","READ");
  ...
  es.get(testRecID).get(plHandle,"TrackCountingHigheffBlah");
  fwlite::ESHandle< PerformanceWorkingPoint > wpHandle;
  es.get(testRecID).get(wpHandle,"TrackCountingHigheffBlah");
